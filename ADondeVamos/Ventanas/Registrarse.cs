    ...
    public partial class Registrarse : Form
    {
        ...
        private void Registrar_Click(object sender, EventArgs e)
        {
            ...
            if (Contrasena==true && NombreUsuario==true)
            {
                ...
                usuario.ObtenerMiNumAmigo(sistema); //aquí ya serializo
                //Serializar
            ...
            else
            {
                if(NombreUsuario==false)
                    MessageBox.Show("Lo sentimos...\nEl correo y/o nombre de usuario ya ha sido utilizado\nPor favor, ingrese nuevos datos", "ERROR", MessageBoxButtons.OK, MessageBoxIcon.Error);
                else
                    MessageBox.Show("Lo sentimos...\nLas contraseñas no coinciden\nPor favor, ingrese de nuevo los datos", "ERROR", MessageBoxButtons.OK, MessageBoxIcon.Error);
